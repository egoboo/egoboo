...
//--------------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------------
static INLINE bool_t VALID_PRT_RANGE( const PRT_REF IPRT ) { return _VALID_PRT_RANGE( IPRT ); }
static INLINE bool_t DEFINED_PRT( const PRT_REF IPRT )     { return _DEFINED_PRT( IPRT );     }
static INLINE bool_t ALLOCATED_PRT( const PRT_REF IPRT )   { return _ALLOCATED_PRT( IPRT );   }
static INLINE bool_t ACTIVE_PRT( const PRT_REF IPRT )      { return _ACTIVE_PRT( IPRT );      }
static INLINE bool_t WAITING_PRT( const PRT_REF IPRT )     { return _WAITING_PRT( IPRT );     }
static INLINE bool_t TERMINATED_PRT( const PRT_REF IPRT )  { return _TERMINATED_PRT( IPRT );  }
...
static INLINE bool_t  DEFINED_PPRT( const prt_t * PPRT )    { return _DEFINED_PPRT( PPRT );    }
static INLINE bool_t  VALID_PRT_PTR( const prt_t * PPRT )   { return _VALID_PRT_PTR( PPRT );   }
static INLINE bool_t  ALLOCATED_PPRT( const prt_t * PPRT )  { return _ALLOCATED_PPRT( PPRT );  }
static INLINE bool_t  ACTIVE_PPRT( const prt_t * PPRT )     { return _ACTIVE_PPRT( PPRT );     }
static INLINE bool_t  TERMINATED_PPRT( const prt_t * PPRT ) { return _TERMINATED_PPRT( PPRT ); }

static INLINE bool_t INGAME_PRT_BASE( const PRT_REF IPRT )  { return _INGAME_PRT_BASE( IPRT );  }
static INLINE bool_t INGAME_PPRT_BASE( const prt_t * PPRT ) { return _INGAME_PPRT_BASE( PPRT ); }

static INLINE bool_t INGAME_PRT( const PRT_REF IPRT )       { return _INGAME_PRT( IPRT );  }
static INLINE bool_t INGAME_PPRT( const prt_t * PPRT )      { return _INGAME_PPRT( PPRT ); }

static INLINE bool_t DISPLAY_PRT( const PRT_REF IPRT )     { return _DISPLAY_PRT( IPRT ) ; }
static INLINE bool_t DISPLAY_PPRT( const prt_t * PPRT )    { return _DISPLAY_PPRT( PPRT ); }
