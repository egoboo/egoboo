...
//--------------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------------
static INLINE bool_t VALID_ENC_RANGE( const ENC_REF IENC ) { return _VALID_ENC_RANGE( IENC ); }
static INLINE bool_t DEFINED_ENC( const ENC_REF IENC )     { return _DEFINED_ENC( IENC );     }
static INLINE bool_t ALLOCATED_ENC( const ENC_REF IENC )   { return _ALLOCATED_ENC( IENC );   }
static INLINE bool_t ACTIVE_ENC( const ENC_REF IENC )      { return _ACTIVE_ENC( IENC );      }
static INLINE bool_t WAITING_ENC( const ENC_REF IENC )     { return _WAITING_ENC( IENC );     }
static INLINE bool_t TERMINATED_ENC( const ENC_REF IENC )  { return _TERMINATED_ENC( IENC );  }
...
static INLINE bool_t  DEFINED_PENC( const enc_t * PENC )    { return _DEFINED_PENC( PENC );    }
static INLINE bool_t  VALID_ENC_PTR( const enc_t * PENC )   { return _VALID_ENC_PTR( PENC );   }
static INLINE bool_t  ALLOCATED_PENC( const enc_t * PENC )  { return _ALLOCATED_PENC( PENC );  }
static INLINE bool_t  ACTIVE_PENC( const enc_t * PENC )     { return _ACTIVE_PENC( PENC );     }
static INLINE bool_t  TERMINATED_PENC( const enc_t * PENC ) { return _TERMINATED_PENC( PENC ); }

static INLINE bool_t INGAME_ENC_BASE( const ENC_REF IENC )  { return _INGAME_ENC_BASE( IENC );  }
static INLINE bool_t INGAME_PENC_BASE( const enc_t * PENC ) { return _INGAME_PENC_BASE( PENC ); }

static INLINE bool_t INGAME_ENC( const ENC_REF IENC )       { return _INGAME_ENC( IENC );  }
static INLINE bool_t INGAME_PENC( const enc_t * PENC )      { return _INGAME_PENC( PENC ); }