...
static INLINE bool _VALID_CHR_RANGE( const CHR_REF ICHR );
static INLINE bool _DEFINED_CHR( const CHR_REF ICHR );
static INLINE bool _ALLOCATED_CHR( const CHR_REF ICHR );
static INLINE bool _ACTIVE_CHR( const CHR_REF ICHR );
static INLINE bool _WAITING_CHR( const CHR_REF ICHR );
static INLINE bool _TERMINATED_CHR( const CHR_REF ICHR );

static INLINE size_t  _GET_INDEX_PCHR( const chr_t * PCHR );
static INLINE CHR_REF _GET_REF_PCHR( const chr_t * PCHR );
static INLINE bool  _DEFINED_PCHR( const chr_t * PCHR );
static INLINE bool  _VALID_CHR_PTR( const chr_t * PCHR );
static INLINE bool  _ALLOCATED_PCHR( const chr_t * PCHR );
static INLINE bool  _ACTIVE_PCHR( const chr_t * PCHR );
static INLINE bool  _TERMINATED_PCHR( const chr_t * PCHR );

static INLINE bool _INGAME_CHR_BASE( const CHR_REF ICHR );
static INLINE bool _INGAME_PCHR_BASE( const chr_t * PCHR );

static INLINE bool _INGAME_CHR( const CHR_REF ICHR );
static INLINE bool _INGAME_PCHR( const chr_t * PCHR );

//--------------------------------------------------------------------------------------------
// BLAH
//--------------------------------------------------------------------------------------------

static INLINE bool _VALID_CHR_RANGE( const CHR_REF ICHR ) { return VALID_CHR_RANGE( ICHR ); }
static INLINE bool _DEFINED_CHR( const CHR_REF ICHR )     { return DEFINED_CHR( ICHR );     }
static INLINE bool _ALLOCATED_CHR( const CHR_REF ICHR )   { return ALLOCATED_CHR( ICHR );   }
static INLINE bool _ACTIVE_CHR( const CHR_REF ICHR )      { return ACTIVE_CHR( ICHR );      }
static INLINE bool _WAITING_CHR( const CHR_REF ICHR )     { return WAITING_CHR( ICHR );     }
static INLINE bool _TERMINATED_CHR( const CHR_REF ICHR )  { return TERMINATED_CHR( ICHR );  }
...
static INLINE bool  _DEFINED_PCHR( const chr_t * PCHR )    { return DEFINED_PCHR( PCHR );    }
static INLINE bool  _VALID_CHR_PTR( const chr_t * PCHR )   { return VALID_CHR_PTR( PCHR );   }
static INLINE bool  _ALLOCATED_PCHR( const chr_t * PCHR )  { return ALLOCATED_PCHR( PCHR );  }
static INLINE bool  _ACTIVE_PCHR( const chr_t * PCHR )     { return ACTIVE_PCHR( PCHR );     }
static INLINE bool  _TERMINATED_PCHR( const chr_t * PCHR ) { return TERMINATED_PCHR( PCHR ); }

static INLINE bool _INGAME_CHR_BASE( const CHR_REF ICHR )  { return INGAME_CHR_BASE( ICHR );  }
static INLINE bool _INGAME_PCHR_BASE( const chr_t * PCHR ) { return INGAME_PCHR_BASE( PCHR ); }

static INLINE bool _INGAME_CHR( const CHR_REF ICHR )       { return TO_C_BOOL( INGAME_CHR( ICHR ) );  }
static INLINE bool _INGAME_PCHR( const chr_t * PCHR )      { return TO_C_BOOL( INGAME_PCHR( PCHR ) ); }
