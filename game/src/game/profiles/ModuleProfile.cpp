...
bool ModuleProfile::moduleHasIDSZ(const char *szModName, IDSZ idsz, size_t buffer_len, char * buffer)
{
    ...
    // Read basic data
    goto_colon_vfs(ctxt, false);  // Name of module...  Doesn't matter
    goto_colon_vfs(ctxt, false);  // Reference directory...
    goto_colon_vfs(ctxt, false);  // Reference IDSZ...
    goto_colon_vfs(ctxt, false);  // Import...
    goto_colon_vfs(ctxt, false);  // Export...
    goto_colon_vfs(ctxt, false);  // Min players...
    goto_colon_vfs(ctxt, false);  // Max players...
    goto_colon_vfs(ctxt, false);  // Respawn...
    goto_colon_vfs(ctxt, false);  // BAD! NOT USED
    goto_colon_vfs(ctxt, false);  // Rank...
