...
#define MAX_DO_LISTS CameraSystem::MAX_CAMERAS
...
void   gfx_system_render_world( const std::shared_ptr<ExtendedCamera> pcam, const int render_list_index, const int dolist_index );
