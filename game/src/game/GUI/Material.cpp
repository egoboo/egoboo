...
Material::Material(const std::shared_ptr<const Texture>& texture, const Math::Colour4f& colour, bool isAlphaBlendingEnabled)
...
const Math::Colour4f& Material::getColour() const {
    return _colour;
}

void Material::setColour(const Math::Colour4f& colour) {
    this->_colour = colour;
}
