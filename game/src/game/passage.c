...
//--------------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------------
bool open_passage( const PASS_REF passage )
{
    /// @author ZZ
...
//--------------------------------------------------------------------------------------------
bool point_is_in_passage( const PASS_REF passage, float xpos, float ypos )
{
    /// @author ZF
    /// @details This return true if the specified X and Y coordinates are within the passage
...
//--------------------------------------------------------------------------------------------
bool object_is_in_passage( const PASS_REF passage, float xpos, float ypos, float radius )
{
    /// @author ZF
    /// @details This return true if the specified X and Y coordinates are within the passage
...
//--------------------------------------------------------------------------------------------
bool close_passage( const PASS_REF passage )
{
    /// @author ZZ
    /// @details This function makes a passage impassable, and returns true if it isn't blocked
    int x, y;
    Uint32 fan, cnt;
    passage_t * ppass;
    CHR_REF character;
    ...
    if ( EMPTY_BIT_FIELD == ppass->mask ) return true;
