...
void load_module(char *smallname)
{
    ...
    char modname[128];
//	char songlist[128];		TODO: see below
//    FILE* playlist;
...
//do we want to implement play music without scripts? 
/*	if(musicvalid)
	{
		//Now load the new music
...
//#endif //SDL_LIL_ENDIAN
    ...
    load_font("basicdat/font.bmp", "basicdat/font.txt", bfalse);
    //printf("Got to load_bars\n");
    load_bars("basicdat/bars.bmp");
    //printf("Got to load_map\n");
    load_map(modname, bfalse);
    //printf("Got to log_madused\n");
    log_madused("basicdat/slotused.txt");
