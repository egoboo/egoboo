...
//---- conversion from the byteorder in egoboo files to the byteorder for this system
...
//---- conversion from the byteorder for this system to the byteorder in egoboo files
