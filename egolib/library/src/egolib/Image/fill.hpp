...
template <typename T>
void fill(T *image, const Colour3b& color)
{ fill_functor<T>()(image, color); }

template <typename T>
void fill(T *image, const Colour3b& color, const Rectangle2f& rectangle)
{ fill_functor<T>()(image, color, rectangle); }

template <typename T>
void fill(T *image, const Colour4b& color)
{ fill_functor<T>()(image, color); }

template <typename T>
void fill(T *image, const Colour4b& color, const Rectangle2f& rectangle)
{ fill_functor<T>()(image, color, rectangle); }
