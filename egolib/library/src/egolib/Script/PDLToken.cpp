...
PDLToken::PDLToken(PDLTokenKind kind, const idlib::hll::location& startLocation,
                   const idlib::hll::location& endLocation, const std::string& lexeme)
    : idlib::hll::token<PDLTokenKind, PDLTokenKind::Unknown>(kind, startLocation, lexeme), m_endLocation(endLocation), m_value(0)
{}

PDLToken::PDLToken(const PDLToken& other)
    : idlib::hll::token<PDLTokenKind, PDLTokenKind::Unknown>(other), m_endLocation(other.m_endLocation), m_value(other.m_value)
{}

PDLToken::PDLToken(PDLToken&& other)
    : idlib::hll::token<PDLTokenKind, PDLTokenKind::Unknown>(std::move(other)), m_endLocation(std::move(other.m_endLocation)), m_value(std::move(other.m_value))
{}
