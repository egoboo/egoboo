...
private:
    ...
    idlib::hll::location m_endLocation;
...
public:
    ...
    PDLToken(PDLTokenKind kind, const idlib::hll::location& startLocation,
             const idlib::hll::location& endLocation,
    ...
    {
        using std::swap;
        swap(static_cast<idlib::hll::token<PDLTokenKind, PDLTokenKind::Unknown>&>(x), static_cast<idlib::hll::token<PDLTokenKind, PDLTokenKind::Unknown>&>(y));
...
public:
    ...
    const idlib::hll::location& getEndLocation() const
    {
    ...
    /// @see getEndlocation
    void setEndLocation(const idlib::hll::location& endLocation)
    {
