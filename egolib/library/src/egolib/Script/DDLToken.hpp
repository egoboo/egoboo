...
struct DDLToken : public idlib::hll::token<DDLTokenKind, DDLTokenKind::Unknown>
{
public:
    ...
    DDLToken(DDLTokenKind kind, const idlib::hll::location& startLocation, const std::string& lexeme = std::string());
    ...
    {
        using std::swap;
        swap(static_cast<idlib::hll::token<DDLTokenKind, DDLTokenKind::Unknown>&>(x),
             static_cast<idlib::hll::token<DDLTokenKind, DDLTokenKind::Unknown>&>(y));
    }
