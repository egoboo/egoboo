...
struct DDLTokenDecoder<TargetType, std::enable_if_t<idlib::hll::internal::is_boolean<TargetType>::value>>
{
    TargetType operator()(const DDLToken& token) const
    {
        TargetType temporary;
        if (!idlib::hll::decoder<TargetType>()(token.get_lexeme(), temporary))
        {
            throw idlib::hll::compilation_error(__FILE__, __LINE__, idlib::hll::compilation_error_kind::lexical, token.get_start_location(),
...
template <typename TargetType>
struct DDLTokenDecoder<TargetType, std::enable_if_t<idlib::hll::internal::is_character<TargetType>::value>>
{
    TargetType operator()(const DDLToken& token) const
    {
        TargetType temporary;
...
template <typename TargetType>
struct DDLTokenDecoder<TargetType, std::enable_if_t<idlib::hll::internal::is_real<TargetType>::value>>
{
    TargetType operator()(const DDLToken& token) const
    {
        TargetType temporary;
...
template <typename TargetType>
struct DDLTokenDecoder<TargetType, std::enable_if_t<idlib::hll::internal::is_integer<TargetType>::value>>
{
    TargetType operator()(const DDLToken& token) const
    {
        TargetType temporary;
...
template<typename TargetType>
struct DDLTokenDecoder<TargetType, std::enable_if_t<idlib::hll::internal::is_natural<TargetType>::value>>
{
    TargetType operator()(const DDLToken& token) const
    {
        TargetType temporary;
...
template <typename TargetType>
struct DDLTokenDecoder<TargetType, std::enable_if_t<idlib::hll::internal::is_string<TargetType>::value>>
{
    TargetType operator()(const DDLToken& token) const
    {
        TargetType temporary;
