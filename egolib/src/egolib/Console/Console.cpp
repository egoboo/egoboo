...
ConsoleHandler::ConsoleHandler() {
	...
	blah.x = 0;
	blah.y = 0;
	blah.w = sdl_scr.width;
	blah.h = sdl_scr.height * 0.25f;
...
void ConsoleHandler::draw_begin()
{
	...
	Matrix4f4f matrix = Ego::Math::Transform::ortho(0, sdl_scr.width, sdl_scr.height, 0, -1, 1);
...
bool Console::draw()
{
	int windowHeight = sdl_scr.height;
