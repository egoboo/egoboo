...
public:
	...
	idlib::signal<void(const text_erased_event&)> text_erased_signal;
	
	/// @brief Signal raised if text was inserted.
	idlib::signal<void(const text_inserted_event&)> text_inserted_signal;
	
	/// @brief Signal raised if text was replaced.
	idlib::signal<void(const text_replaced_event&)> text_replaced_signal;

	/// @brief Signal raised if text was set.
	idlib::signal<void(const text_set_event&)> text_set_signal;
