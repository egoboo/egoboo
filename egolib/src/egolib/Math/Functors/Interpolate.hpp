 ...
 */
template <typename Type, InterpolationMethod Method, typename _EnabledType = void>
struct Interpolate;

template <typename ResultType, typename OperandType, typename ParameterType>
ResultType interpolate(const OperandType& x, const OperandType& y, const ParameterType& t);
