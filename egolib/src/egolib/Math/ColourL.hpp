...
struct Colour<_ColourSpaceType, std::enable_if_t<Internal::IsL<_ColourSpaceType>::value>> :
...
public:
    ...
    /**
     * @brief
     *  Construct this colour with the specified component value.
     * @param l
     *  the component value of the luminance component
     * @throws Id::OutOfBoundsException
     *  if @a l is not within the range of ColourSpaceType::min() (inclusive) and ColourSpaceType::max() (inclusive)
     */
