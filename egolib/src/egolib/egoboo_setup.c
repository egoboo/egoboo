...
egoboo_config_t::egoboo_config_t() :
    ...
    graphic_textureFilter_minFilter(id::texture_filter_method::linear, "graphic.textureFilter.minFilter", "texture filter used for minification",
    {
        { "none", id::texture_filter_method::none },
        { "nearest", id::texture_filter_method::nearest },
        { "linear", id::texture_filter_method::linear },
    }),
    graphic_textureFilter_magFilter(id::texture_filter_method::linear, "graphic.textureFilter.magFilter", "texture filter used for magnification",
    {
        { "none", id::texture_filter_method::none },
        { "nearest", id::texture_filter_method::nearest },
        { "linear", id::texture_filter_method::linear },
    }),
    graphic_textureFilter_mipMapFilter(id::texture_filter_method::linear, "graphic.textureFilter.mipMapFilter", "filter used for mip map selection",
    {
        { "none", id::texture_filter_method::none },
        { "nearest", id::texture_filter_method::nearest },
        { "linear", id::texture_filter_method::linear }
