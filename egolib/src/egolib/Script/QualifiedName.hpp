...
namespace Ego
{
    namespace Script
    {
         ...
         *  @endcode
         * @remark
         *  std::hash and std::equal_to have specializations for qualified names
         * @todo
         *  We can also sort qualified names. Determine which STL template has to be specialized for that.
         */
...
namespace std
{
    ...
    struct equal_to<QualifiedName>
    {
        ...
        {
            return equal_to<>()(x.getString(),y.getString());
        }
    };
    ...
    struct less<QualifiedName>
    {
        bool operator()(const QualifiedName& x, const QualifiedName& y) const
        {
            ...
            return less<>()(x.getString(), y.getString());
        }
    };
}