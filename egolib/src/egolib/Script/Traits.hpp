...
namespace Ego
{
    namespace Script
    {
        ...
        public:
            ...
            {
                return static_cast<ExtendedType>(std::numeric_limits<Type>::max()) + 3;
            }
            /**
             * @brief
            ...
            {
                return '\0' != echr
                    && echr >= static_cast<ExtendedType>(std::numeric_limits<Type>::min())
                    && echr <= static_cast<ExtendedType>(std::numeric_limits<Type>::max())
                    ;
            }
