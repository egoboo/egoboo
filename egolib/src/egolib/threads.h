...
// thread control
    bool egolib_thread_req_end( egolib_thread_t * );
    bool egolib_thread_req_quit( egolib_thread_t * );
    bool egolib_thread_kill( egolib_thread_t * );

// accessors
    bool egolib_thread_running( const egolib_thread_t * );
    bool egolib_thread_check_started( const egolib_thread_t * );
    bool egolib_thread_check_done( const egolib_thread_t * );
    bool egolib_thread_check_error( const egolib_thread_t * );
