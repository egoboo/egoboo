...
uint32_t make_rgb(SDL_Surface *surface, const Ego::Math::Colour3b& colour)
{
    if (!surface)
    {
        throw id::null_error(__FILE__, __LINE__, "surface");
...
uint32_t make_rgba(SDL_Surface *surface, const Ego::Math::Colour4b& colour)
{
    if (!surface)
    {
        throw id::null_error(__FILE__, __LINE__, "surface");
...
std::shared_ptr<SDL_Surface> render_glyph(TTF_Font *sdl_font, uint16_t code_point, const Ego::Math::Colour4b& color)
{
...
Math::Colour4b get_pixel_functor<SDL_Surface>::operator()(const SDL_Surface *surface, const Point2f& point) const
{
    if (!surface)
    {
        throw id::null_error(__FILE__, __LINE__, "surface");
...
void fill_functor<SDL_Surface>::operator()(SDL_Surface *surface, const Math::Colour3b& color) const
{
    if (!surface)
    {
        throw id::null_error(__FILE__, __LINE__, "surface");
...
void fill_functor<SDL_Surface>::operator()(SDL_Surface *surface, const Math::Colour4b& color) const
{
    if (!surface)
    {
        throw id::null_error(__FILE__, __LINE__, "surface");
...
void fill_functor<SDL_Surface>::operator()(SDL_Surface *surface, const Math::Colour3b& color, const Rectangle2f& rectangle) const
{
    if (!surface)
    {
        throw id::null_error(__FILE__, __LINE__, "surface");
...
void fill_functor<SDL_Surface>::operator()(SDL_Surface *surface, const Math::Colour4b& color, const Rectangle2f& rectangle) const
{
    if (!surface)
    {
        throw id::null_error(__FILE__, __LINE__, "surface");
...
void set_pixel_functor<SDL_Surface>::operator()(SDL_Surface *surface, const Math::Colour3b& color, const Point2f& point) const
{
    if (!surface)
    {
        throw id::null_error(__FILE__, __LINE__, "surface");
...
void set_pixel_functor<SDL_Surface>::operator()(SDL_Surface *surface, const Math::Colour4b& color, const Point2f& point) const
{
    if (!surface)
    {
        throw id::null_error(__FILE__, __LINE__, "surface");
