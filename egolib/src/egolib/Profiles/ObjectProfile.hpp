...
public:
    ...
    **/
    ...
    inline id::interval<float> getStartingExperience() const {return _startingExperience;}
    ...
    **/
    const id::interval<float>& getAttributeGain(Ego::Attribute::AttributeType type) const;

    /**
    * @return
    *   Get base starting attribute this Object spawns with (can be random range)
    **/
    const id::interval<float>& getAttributeBase(Ego::Attribute::AttributeType type) const;
...
private:
    ...
    std::array<id::interval<float>, Ego::Attribute::NR_OF_PRIMARY_ATTRIBUTES> _baseAttribute; ///< Base attributes
    std::array<id::interval<float>, Ego::Attribute::NR_OF_PRIMARY_ATTRIBUTES> _attributeGain; ///< Attribute increase each level
    ...
    id::interval<float>     _startingExperience;  ///< Starting experience
