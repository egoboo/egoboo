...
bl_info = {
	...
	"author": "Michael Heilmann, based on the work of DarkRain/Bob Holcomb/Sebastian Lieberknecht/Dao Nguyen/Bernd Meyer/Damien Thebault/Erwan Mathieu/Takehiko Nawata",
	"version": (1, 1),
	"blender": (2, 68, 0),
...
class Util:
	...
	def applyModifiers(object, possibleNewName):
		...
		for modifier in modifiedObj.modifiers:
			...
			print("applying modifier " + modifier.type)
